...
│  │  │  (unified│  │  (API     │  │  (FFI     │           │   │
│  │  │  unified-api-adapter│  │   layer) │  │   bridge) │           │   │
│  │  └──────────┘  └──────────┘  └──────────┘           │   │
│  └─────────────────────────────────────────────────────┘   │
└─────────────────────────────────────────────────────────────┘
----
...
Uses Zig FFI via unified-api-adapter for actual Telegram API calls.
...
* `zig/telegram.zig`: Telegram API bindings using unified-api-adapter
...
4. Zig code uses unified-api-adapter to create session
...
* unified-api-adapter (Zig library)
...
* Complete Zig FFI implementation with unified-api-adapter
