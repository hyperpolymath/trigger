...
//
= Code of Conduct
:description: Community conduct guidelines for Trigger project
:toc: auto
:toclevels: 3

// TEMPLATE INSTRUCTIONS (delete this block before final publish)
// ============================================================================
// Replace all {{PLACEHOLDER}} values:
//   {{PROJECT_NAME}}     - Trigger
//   {{OWNER}}            - hyperpolymath
//   {{REPO}}             - trigger
//   {{CONDUCT_EMAIL}}    - conduct@hyperpolymath.dev
//   {{CONDUCT_TEAM}}     - Trigger Maintainers
...
. *Email* {CONDUCT_EMAIL} with subject line "Appeal: [Original Report ID]"
...
- Open a https://{FORGE}/{OWNER}/{REPO}/discussions[Discussion] (for general questions)
