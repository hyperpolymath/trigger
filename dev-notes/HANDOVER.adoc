...
* Address all issues from panic-attack report - IN PROGRESS
  ...
  - Issues found:
    - scripts/trigger-launcher.sh: 2 CommandInjection (eval usage), 23 unquoted variable expansions
    - ffi/zig/twitter/twitter.zig: 8 UnsafeCode (pointer casts), 12 UncheckedError (TODO markers)
    - ffi/zig/discord/discord.zig: 11 UnsafeCode (pointer casts)
    - ffi/zig/telegram/telegram.zig: 6 UnsafeCode (pointer casts)
    - ffi/zig/crypto/crypto.zig: 2 UnsafeFFI (C interop)
